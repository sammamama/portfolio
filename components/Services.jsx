    ...
    <div className="px-4 py-8 max-w-7xl mx-auto">
      ...
      <div className="grid gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        ...
        <div className="bg-neutral-800/70 md:row-span-2 lg:row-span-1 text-neutral-300 rounded-lg p-5
         flex flex-col shadow-lg transform hover:scale-105 
        ...
        {/* Fullstack Webapps */}
        <div className="bg-neutral-400 text-neutral-800 rounded-lg p-5 flex flex-col shadow-lg transform hover:scale-105 transition-transform duration-300">
        ...
        <div className="bg-neutral-400 text-neutral-800 rounded-lg 
         p-5 flex flex-col shadow-lg transform hover:scale-105 transition-transform duration-300 xl:col-span-full">
          <div className="flex items-center mb-3">
